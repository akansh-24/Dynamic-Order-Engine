# services/inventory_service/src/db_service.py
import logging
...
def create_inventory_item(db: Session, item_data: dict):
...
def check_and_update_inventory(db: Session, order_data: dict):
